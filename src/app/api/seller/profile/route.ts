...
export async function GET(req: NextRequest) {
  ...
  const user = await prisma.user.findUnique({
    ...
    select: { name: true, email: true, phone: true, brandName: true, gstNumber: true, bankHolder: true, bankAccount: true, bankIfsc: true, bankName: true, metaAdAccountId: true, shopifyStore: { select: { storeUrl: true, storeName: true } } },
  });
