...
import { emailNdrActionedByAdmin } from "@/lib/email";
...
export async function POST(req: NextRequest) {
  ...
  const payload = {
    ...
    state:    state   || "",
    country:  "India",
    comments: comments || (action === "REATTEMPT" ? "Re-attempt delivery (admin)" : "Return to origin (admin)"),
  };
