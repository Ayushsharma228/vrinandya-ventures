...
const TESTIMONIALS = [
  ...
  {
    initials: "HG",
    name: "Hyperloop Global",
    store: "hyperloopglobal.store",
    city: "India",
    niche: "Health & Wellness",
    quote: "Running 3 Meta campaigns for our Detox Foot Patch. ₹60.3K in sales, 121 orders, 109 purchases from ads — all in under 30 days. ₹7,737 ad spend and a 7.8x ROAS. Fulfilment is completely hands-off, I just watch the numbers go up.",
    metrics: [
      { label: "Revenue", value: "₹60.3K", sub: "in 28 days" },
      { label: "Orders", value: "121", sub: "fulfilled" },
      { label: "ROAS", value: "7.8x", sub: "on Meta Ads" },
      { label: "Ad Spend", value: "₹7,737", sub: "109 purchases" },
    ],
    images: [
      { src: "/testimonials/Shopify-hyperloopglobal.png", alt: "Hyperloop Global Shopify Dashboard – ₹60.3K revenue, 121 orders" },
      { src: "/testimonials/meta-hyperloopglobal.png", alt: "Hyperloop Global Meta Ads – 7.8x ROAS, 109 purchases" },
    ],
    color: C.indigo,
  },
  {
