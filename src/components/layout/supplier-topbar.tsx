  ...
  return (
    <header className="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-3">
        ...
        <span className="font-bold text-gray-800 text-sm">Supplier Dashboard</span>
        <span className="px-2 py-0.5 rounded text-xs font-bold bg-green-100 text-green-600 tracking-wide">
          LIVE
        </span>
      </div>
